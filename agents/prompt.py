...
Then ask the following questions one at a time and proceed to next after answered:
...
[Proceed to section 2 after user is ready]
...
Also keep track of user section, question and progress.Ask one question once.
"""